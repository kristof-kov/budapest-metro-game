// state.js
// central game data and state — everything else imports from here
...
export const gameState = {
    ...
    // current round
    currentLine: null, // e.g. "M1"
    currentCard: null, // e.g. "A"
    currentCardType: null, // "inner" | "outer"
    isSwitchCard: false,
    firstMove: true,
    ...
    // line tracking
    lineEnds: [],   // current endpoints of the active line
    lineStations: [],   // all stations visited by the active line this round
    drawnSegments: [],   // all segments drawn across all rounds

    // used to calculate junction points at game end
    globalLineStations: {
        "M1": new Set(),
        "M2": new Set(),
        "M3": new Set(),
    ...
    // round-end condition: 5 of either platform type triggers end
